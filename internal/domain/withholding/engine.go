...
// those in.
func CalculateWithMinimumBase(rule TaxRule, uvtValue decimal.Decimal, baseAmount decimal.Decimal) Calculation {
...
// to withhold.
func CalculateReteiva(rule TaxRule, ivaValue decimal.Decimal) Calculation {
...
func newCalculation(rule TaxRule, base, tariff, value decimal.Decimal, justification string) Calculation {
	return Calculation{
...
// Justification.
func NotApplicable(taxType TaxType, reason string) Calculation {
	return Calculation{
		TaxType:         taxType,
