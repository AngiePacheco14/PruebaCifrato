...
var _ repository.InvoiceParser = (*Parser)(nil)

func (p *Parser) Parse(xmlData []byte) (*entity.Invoice, error) {
	...
	case "Invoice":
		...
		inv, err := mapInvoice(&xi, enums.XMLTypeInvoice)
		if err != nil {
	...
	case "AttachedDocument":
		...
		inv, err := mapInvoice(&xi, enums.XMLTypeAttachedDocument)
		if err != nil {
			return nil, fmt.Errorf("xmlparser: %w", err)
		}
		return inv, nil
