...
func InvoiceToModel(inv *invoice.Invoice) *models.InvoiceModel {
	lines := make([]models.InvoiceLineModel, len(inv.Lines))
...
func ModelToInvoice(m *models.InvoiceModel) *invoice.Invoice {
	...
	return &invoice.Invoice{
		...
		XMLType:                 invoice.XMLType(m.XMLType),
...
func InvoiceLineToModel(l *invoice.InvoiceLine) *models.InvoiceLineModel {
	return &models.InvoiceLineModel{
...
func ModelToInvoiceLine(m *models.InvoiceLineModel) *invoice.InvoiceLine {
